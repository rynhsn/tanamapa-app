...
<div class="centered">
  <form method="get" action="config">
    ...
    <tr><td><label for="blynk">Auth token:</label></td><td><input type="text" name="blynk" value="YVqLANUGQDSPlgtXUW2rEH5LO333qcmP" pattern="[-_a-zA-Z0-9]{32}" maxlength="32" required="required" readonly></td></tr>
    <tr><td><label for="host">Host:</label></td>       <td><input type="text" name="host" value="blynk.cloud" length="64" readonly></td></tr>
    <tr><td><label for="port_ssl">Port:</label></td>   <td><input type="number" name="port_ssl" value="443" min="1" max="65535" readonly></td></tr>
    </table><br/>
